		...
		<div className='mt-auto mb-auto font-semibold text-center flex flex-col gap-5'>
			...
			<BlurFade delay={0.25} inView>
				<div className='flex gap-4'>
					<a href='/src/assets/Nikita Maryniuk React Developer.docx' download className="btn text-lg font-normal bg-white text-black px-3 py-2 rounded-lg transition duration-300 ease-in-out hover:bg-[#ff00aa] hover:text-white">Download CV</a>
					<a href='/src/assets/Nikita Maryniuk React Developer.docx' className="btn text-lg font-normal bg-white text-black px-3 py-2 rounded-lg transition duration-300 ease-in-out hover:bg-[#ff00aa] hover:text-white">Contact Info</a>
					</div>
				</BlurFade>
			</div>
