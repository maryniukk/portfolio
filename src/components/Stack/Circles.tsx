...
export function Circles() {
	...
	return (
		<div
			className='relative container flex min-w-[280px] w-[800px] pb-[60px] items-center justify-center overflow-hidden rounded-2xl border p-10 md:shadow-xl'
			ref={containerRef}
		>
			<div className='flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10'>
				<div className='flex flex-row items-center justify-between'>
					<Circle ref={div1Ref}>
						<RiNextjsFill className='text-white dark:text-black' />
					</Circle>
					<Circle ref={div5Ref}>
				...
				<div className='flex flex-row items-center justify-between'>
					<Circle ref={div2Ref}>
						<RiTailwindCssFill className='text-[#38BDF9]' />
					</Circle>
					<Circle ref={div4Ref} className='size-16'>
						<FaReact className='text-white' />
					</Circle>
					<Circle ref={div6Ref}>
						<SiTypescript className='text-[#2E79C7]' />
					</Circle>
				</div>
				<div className='flex flex-row items-center justify-between'>
					<Circle ref={div3Ref}>
						<SiRedux className='text-[#7649BB]' />
					</Circle>
					<Circle ref={div7Ref}>
						<FaSass className='text-[#C76494]' />
					</Circle>
				</div>
			</div>
